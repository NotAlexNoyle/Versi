const cons = {
  version: '2.2.6',
  secretKey: {
    ACCESS_TOKEN: 'versi_access_token',
    DEVICE_ID: 'versi_device_id',
    USER_ID: 'versi_user_id',
    BASE_URL: 'versi_hs_base_url',
  },
  DEVICE_DISPLAY_NAME: 'Versi Web',
  IN_CINNY_SPACES: 'in.versi.spaces',
  tabs: {
    HOME: 'home',
    DIRECTS: 'dm',
  },
  ...
  actions: {
    navigation: {
      ...
      OPEN_TEXTTRANSLATE: 'OPEN_TEXTTRANSLATE',
    ...
    settings: {
      ...
      TOGGLE_SELF_TRANSLATE: 'TOGGLE_SELF_TRANSLATE',
  ...
  events: {
    navigation: {
      ...
      TEXTTRANSLATE_OPENED: 'TEXTTRANSLATE_OPENED',
